    ...
    case "OPEN":
      return (
        <div className="flex flex-col items-center gap-6 w-full max-w-2xl">
          ...
          >
            <p className="text-xl sm:text-2xl font-black text-white">{question.questionText}</p>
          </div>
          <input
            type="text"
            ...
            className="w-full bg-white/10 border-2 border-white/20 focus:border-[#4CAF5A] outline-none rounded-2xl px-5 py-3.5 sm:px-6 sm:py-4 text-white text-base sm:text-lg placeholder:text-white/30 transition-colors"
          />
        </div>
      );
