        ...
        <div className="grid grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Le passeport santé est un parcours numérique interactif conçu pour
              accompagner les jeunes dans la découverte des grands enjeux liés à
              leur santé.
            </p>
            <ul className="space-y-4 text-gray-700 text-base">
              ...
              <li className="flex gap-3">
                <span className="shrink-0 font-bold text-brand-green">·</span>
                Tu peux également profiter d&apos;un temps libre pour enrichir
                tes connaissances !
              </li>
            </ul>
          </div>
